...
newCipher = AES.new(encoded_key, AES.MODE_ECB)

print("Encrypted flag received: ", ciphertext.hex())
given = ciphertext.hex()
print(f"cip {ciphertext} ours = {bytes.fromhex(given)}")
